...
darwin-core-xxxxxxxxx-xxxxx   1/1     Running   30s
darwin-core-xxxxxxxxx-xxxxx   1/1     Running   30s

🔗 Service:
NAME          TYPE        CLUSTER-IP    PORT(S)
darwin-core   ClusterIP   10.43.x.x     8000,50051,9090
...
# 6. Verify
kubectl logs -f deployment/darwin-core -n darwin-core-dev
...
# Load context
./.darwin/agents/darwin-omniscient-agent.sh
# Sees: Agent 1 active on darwin-core
...
agents:
  omniscient:
    ...
    memory:
      enabled: true
      backend: qdrant
      endpoint: http://qdrant.darwin-core.svc.cluster.local:6333
  ...
  auto_deploy:
    ...
    environments:
      dev:
        cluster: k3s-dev
        namespace: darwin-core-dev
        health_check_timeout: 180
      
      staging:
        cluster: k3s-staging
        namespace: darwin-core-staging
...
request = ChatRequest(
    message="How to scale darwin-core?",
